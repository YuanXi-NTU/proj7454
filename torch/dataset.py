...
class ClipData(Dataset):
    def __init__(
        ...
        self.root = root
        self.transform_image = _transform(224)(train)# clip size
        self.num_classes = num_classes
        self.clip_txt=torch.cat([clip.tokenize(f"a photo of a {c}") for c in ori_classes])
    ...
    def __getitem__(self, index):
        ...
        #sample['soft_label'] = soft_label
        del sample#['relations']
        return data, soft_label, self.clip_txt #sample
